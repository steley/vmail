  ...
  return (
    ...
    <div>
      <div className="max-w-[1400px] ">
        <p className="mt-8">
          Welcome to TempMail.cc! These Terms of Service ("Terms") govern your
        ...
        <p className="mt-4">
          TempMail.cc is a minimalistic temporary email service that allows you to
          ...
          TempMail.cc operates on the Cloudflare network, guaranteeing a
        ...
        <p className="mt-4">
          2.1 Availability: Please note that TempMail.cc is not available in China
          Mainland. We apologize for any inconvenience caused.
        </p>
        <p className="mt-4">
          2.2 Copyright: All copyrights related to TempMail.cc and its services
          belong to TempMail.cc. You may not copy, reproduce, distribute, modify,
          or create derivative works of TempMail.cc or any part thereof without
          explicit permission from TempMail.cc.
        </p>
        ...
        <p className="mt-4">
          ...
          personal information to use TempMail.cc. However, you are solely
          responsible for maintaining the confidentiality of any temporary email
          addresses generated through our service.
        </p>
        <p className="mt-4">
          3.2 Prohibited Activities: While using TempMail.cc, you agree not to
        ...
        <p className="mt-4">
          TempMail.cc is provided on an "as is" and "as available" basis. We do
          not warrant that our services will be uninterrupted, error-free, or
          secure. Your use of TempMail.cc is at your own risk, and we disclaim all
        ...
        <p className="mt-4">
          To the maximum extent permitted by law, in no event shall TempMail.cc or
          ...
          from your access to or use of TempMail.cc or any content or services
          provided through TempMail.cc.
        </p>
        ...
        <p className="mt-4">
          ...
          posting. Your continued use of TempMail.cc after the posting of any
        ...
        <p className="mt-4">
          ...
          laws of the jurisdiction where TempMail.cc is located. Any disputes
